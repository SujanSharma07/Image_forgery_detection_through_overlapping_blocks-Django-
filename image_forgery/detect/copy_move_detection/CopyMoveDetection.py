import os
import time
import detect.copy_move_detection.ImageObject as ImageObject
import cv2

def detect_dir(sourceDirectory, outputDirectory, blockSize=2):
    """
...
def detect(sourceDirectory, fileName, outputDirectory, blockSize=8):
    """
...
def main():
    path = detect("accounts/media/detect/","empty.png","accounts/media/detect")
